...
function canarySystemInstructions() {
  return [
    ...
    "Output two 2x2 matrices in bullet points.",
    "Matrix 1 X-axis: Known <-> Unknown.",
    "Matrix 1 Y-axis: Agreed <-> Contested.",
    "Matrix 2 X-axis: Certain <-> Uncertain.",
    "Matrix 2 Y-axis: Internal <-> External.",
    ...
    "- If evidence is thin, say NOT IN TRANSCRIPTS.",
"**Axes**",
"- Matrix 1 X-axis: Known <-> Unknown",
"- Matrix 1 Y-axis: Agreed <-> Contested",
"- Matrix 2 X-axis: Certain <-> Uncertain",
"- Matrix 2 Y-axis: Internal <-> External",
    ...
    "**2x2 matrix 1: Known / Unknown x Agreed / Contested**",
"| - | Known | Unknown |",
"|---|---|---|",
...
"**2x2 matrix 2: Certain / Uncertain x Internal / External**",
"| - | Certain | Uncertain |",
"|---|---|---|",
"| Internal | - 3-4 concise bullets on factors inside the organisation that are clear, established, or already visible.<br>- Each bullet should be specific. | - 3-4 concise bullets on internal organisational unknowns, unresolved decisions, tensions, or capability gaps.<br>- Each bullet should be specific. |",
"| External | - 3-4 concise bullets on external environment, market, policy, technology, cultural, or global factors that are clear or already visible.<br>- Each bullet should be specific. | - 3-4 concise bullets on external uncertainties, weak signals, risks, disruptions, or global/environmental unknowns.<br>- Each bullet should be specific. |", 

"**Universal themes**",
    "- 3 concise bullets only.",
    "- Summarise the most widely shared themes from the Agreed row.",
    "- Each bullet must be under 14 words.",
    "**Unique themes**",
    "- 3 concise bullets only.",
    "- Summarise the more distinctive, contested, or divergent themes from the Contested row.",
    "- Each bullet must be under 14 words.",
    "",

    "Rules:",
    "- Matrix cells should be richer than the final summaries.",
    "- Avoid vague phrases like 'important', 'complex', 'dynamic', or 'significant' unless explained specifically.",
    "- Prefer concrete nouns and verbs from the transcripts.",
    "- Do not write paragraphs in the final summaries.",
    "- Do not invent participant quotes.",
    "- If something is not supported by the transcripts, say so.",
    "- Use British English.",
    "- Always produce both 2x2 matrices.",
  ].join("\n");
}
